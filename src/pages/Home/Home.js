          ...
          const backendResponse = await axios
            ...
            .then((res) => {
              if (res.data.predicted_verbs.length > 0) {
                ...
                const synonyms = res.data.similar;
        ...
        Your browser does not support the audio element.
          ...
          <div className="row">
            <div className="col-lg-6 animate-fade-left mt-5">
              <h1 style={{fontSize:'100px'}} className="display-4">ListenEd</h1>
              <p className="lead">
              ශ්‍රී ලංකාවෙ පළමු කටහඬ හරහා පාලනය වන Audiobook පුස්තකාලය වෙත ඔබව සාදරෙයෙන් පිලිගනිමු.
              </p>
              <button
...
<div ref={targetRef} >
    ...
    ListenEd ශ්‍රී ලංකාවෙ පළමු කටහඬ හරහා පාලනය වන Audiobook පුස්තකාලයයයි. ශ්‍රී ලංකාවෙ විශ්වවිද්‍යාලයයන් වල ඉගෙනුම ලබන දෘශ්‍යාභාතිත සිසුන් සඳහා විශේෂයෙන් මෙම මෘදුකාංගය නිර්මාණය කර ඇත. සියලුම විධානයන් සිංහල භාෂාවෙන් කටහඬ විධාන මගින් පාලනය කල හැකි පරිදි ListenEd නිර්මාණය කර ඇත. 
              </p>
